...
@step("industry/dtr/create_shell_descriptor", aliases=["create_shell_descriptor"])
...
@step("industry/dtr/get_shell_descriptor", aliases=["get_shell_descriptor"])
...
@step("industry/dtr/create_submodel_descriptor", aliases=["create_submodel_descriptor"])
...
@step("industry/dtr/delete_shell_descriptor", aliases=["delete_shell_descriptor"])
