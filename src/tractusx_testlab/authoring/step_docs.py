...
def summary_and_body(obj: Any) -> tuple[str, str]:
...
def step_anchor(step_type: str) -> str:
    """The stable page anchor of a step, e.g. ``connector-consumer-do_dsp``.

    Set explicitly because the heading's own slug drops the slashes, which
    would run the segments of the id together.
    """
