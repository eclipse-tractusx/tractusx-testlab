...
| `cac` | O **[PROP]** | CAC identifiers this step/validation verifies. See [§9.1](../extensions.md#91-cac-traceability-cac-p1). |
| `if` | O **[PROP]** | Expression guarding execution of the step or validation. See [§9.2](../extensions.md#92-conditionals-if-validateany_of-validateall_of-p2). |
