...
- The [step reference page](../api-reference/steps.md) is generated from it, so a parameter you rename in code cannot go stale in the docs.
...
```bash
testlab docs           # rewrites docs/api-reference/steps.md
...
- [Step Reference](../api-reference/steps.md) — the generated catalogue of every step
